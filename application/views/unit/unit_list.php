<div class="row" style="margin-bottom: 10px">
        ...
        <th>Action</th>
            ...
            <td><?php echo $unit->deskripsi_unit ?></td>
            <td><?php echo $unit->alamat ?></td>
            <td style="text-align:center" width="200px">
                <?php 
                echo anchor(site_url('unit/update/'.$unit->id_unit),'Update'); 
                echo ' | '; 
                echo anchor(site_url('unit/delete/'.$unit->id_unit),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                ?>
            </td>
        </tr>
                <?php
